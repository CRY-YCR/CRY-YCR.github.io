...
因此有$\sigma(\mathcal{K} \subseteq \mathcal{H})$,故只需证$1_{[c,\infty)]}关于
...
因此有 $\sigma( \mathcal{K})_b\subseteq\mathcal{H}$,故只需证 $\mathbf{1}_{[c,\infty)}$ 关于 $\sigma(\mathcal{K})_b$ 可测即可. 从